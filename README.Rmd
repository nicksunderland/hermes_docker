...
To ensure all datasets are meta-analysis ready, they are harmonized to **GRCh37 / Hg19**. If the input is GRCh38 it is lifted down to GRCh37 so all downstream outputs share the same build.
...
The final pipeline output is a tab-separated value (TSV) file, harmonized to GRCh37 and annotated with the latest dbSNP identifiers.
